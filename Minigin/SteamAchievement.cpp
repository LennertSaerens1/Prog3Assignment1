...
{
	_ACH_ID(ACH_WIN_ONE_GAME, "Win a game"),
	_ACH_ID(ACH_WIN_100_GAMES, "Win 100 games"),
	_ACH_ID(ACH_TRAVEL_FAR_ACCUM, "Travel far"),
	_ACH_ID(ACH_TRAVEL_FAR_SINGLE, "Travel further"),
};
